...
namespace App4.Models
{
    public class Artisanat
    {
        ...
        public Uri ImageArtisanat { get; set; }

        public Uri ImageArtisanat2 { get; set; }

        public Uri ImageArtisanat3 { get; set; }
        public Uri OwnerImg { get; set; }
        public int idowner { get; set; }

    }
    public class ArtisanatMangaer
    {
        public static List<Artisanat> artisanatlist = new List<Artisanat>();
        public static List<Artisanat> subCategoryList = new List<Artisanat>();
        ...
        public static async void LoadContentsWithCategory(String category)
        {
            ...
            try
            {
                if (category.Equals("Artisanat"))
                {
                    ...
                    o = JArray.Parse(data);
                    artisanatlist = new List<Artisanat>();
                    for (int i = 0; i < o.Count; i++)
                    {
                        ...
                        artisanatlist.Add(new Artisanat {id=fk_id, Owner = u[0]["prenom"] + " " + u[0]["nom"], OwnerTel = u[0]["tel"] + "",idowner=fkowner, Name = o[i]["name"] + "", OwnerImg = imgOwn, Lieu = u[0]["adresse"] + "", Quantite = o[i]["quantity"] + "", Prix = price, Date = o[i]["date"] + "", ImageArtisanat = img1 });
                    }
                }
            }
        ...
        public static async void LoadContentsWithSubCategory(String subcategory, String category)
        {
            ...
            try
            {
                ...
                string data = datatask.Result;
                o = JArray.Parse(data);
                subCategoryList = new List<Artisanat>();
                for (int i = 0; i < o.Count; i++)
                {
                    int fk_id = (int)o[i]["id"];
                    Task<string> datataskuser = httpClient.GetStringAsync("http://localhost/pimtls/getUserFromProduct.php?id=" + fk_id);
                    ...
                    subCategoryList.Add(new Artisanat {id=fk_id, Owner = u[0]["prenom"] + " " + u[0]["nom"], OwnerTel = u[0]["tel"] + "",idowner=fkowner, Name = o[i]["name"] + "", OwnerImg =imgOwn, Lieu = u[0]["adresse"] + "", Quantite = o[i]["quantity"] + "", Prix = price, Date = o[i]["date"] + "", ImageArtisanat = img1 });
                }
        ...
        public static List<Artisanat> GetArtisanat()
        {
            LoadContentsWithCategory("Artisanat");
            return artisanatlist;
        }
        public static List<Artisanat> GetPoterie()
        {
            var FruitList = new List<Artisanat>();
            LoadContentsWithSubCategory("Poterie", "Artisanat");
 ...
 */
        ...
        public static List<Artisanat> GetTappisserie()
        {
            var FruitList = new List<Artisanat>();
            LoadContentsWithSubCategory("Tappisserie", "Artisanat");
            /* FruitList.Add(new Nourriture { Owner = "Mazouni Anas", OwnerTel = "98.227.237", Name = "Pastéques", OwnerImg = "Assets/Anas.png", Lieu = "SidiBouzid,Tok", Quantite = "200", Prix = 1, Date = "02/02/2016", ImageNourriture = "Assets/Pasteque.jpg" });
             FruitList.Add(new Nourriture { Owner = "Sta Mohamed", OwnerTel = "21.225.987", Name = "Cerises", OwnerImg = "Assets/Sta.png", Lieu = "Nabeul,Kélibia", Quantite = "120", Prix = 2, Date = "19/11/2016", ImageNourriture = "Assets/Cerise.jpg" });
             FruitList.Add(new Nourriture { Owner = "Bouzwer Amar", OwnerTel = "98.922.123", Name = "Péches", OwnerImg = "Assets/Amar.png", Lieu = "Beja,Matteur", Quantite = "80", Prix = 5, Date = "15/12/2016", ImageNourriture = "Assets/Peche.jpg" });
             FruitList.Add(new Nourriture { Owner = "Benkhelifa Myriam", OwnerTel = "98.922.123", Name = "Pommes", OwnerImg = "Assets/UserHraderImg.png", Lieu = "Kef,Tajerouine", Quantite = "200", Prix = 5, Date = "15/12/2016", ImageNourriture = "Assets/Pomme.jpg" });
 */
        ...
        public static List<Artisanat> GetBroderie()
        {
            var FruitList = new List<Artisanat>();
            LoadContentsWithSubCategory("Broderie", "Artisanat");
            /* FruitList.Add(new Nourriture { Owner = "Mazouni Anas", OwnerTel = "98.227.237", Name = "Pastéques", OwnerImg = "Assets/Anas.png", Lieu = "SidiBouzid,Tok", Quantite = "200", Prix = 1, Date = "02/02/2016", ImageNourriture = "Assets/Pasteque.jpg" });
             FruitList.Add(new Nourriture { Owner = "Sta Mohamed", OwnerTel = "21.225.987", Name = "Cerises", OwnerImg = "Assets/Sta.png", Lieu = "Nabeul,Kélibia", Quantite = "120", Prix = 2, Date = "19/11/2016", ImageNourriture = "Assets/Cerise.jpg" });
             FruitList.Add(new Nourriture { Owner = "Bouzwer Amar", OwnerTel = "98.922.123", Name = "Péches", OwnerImg = "Assets/Amar.png", Lieu = "Beja,Matteur", Quantite = "80", Prix = 5, Date = "15/12/2016", ImageNourriture = "Assets/Peche.jpg" });
             FruitList.Add(new Nourriture { Owner = "Benkhelifa Myriam", OwnerTel = "98.922.123", Name = "Pommes", OwnerImg = "Assets/UserHraderImg.png", Lieu = "Kef,Tajerouine", Quantite = "200", Prix = 5, Date = "15/12/2016", ImageNourriture = "Assets/Pomme.jpg" });
 */
        ...
        public static List<Artisanat> GetPeinture()
        {
            var FruitList = new List<Artisanat>();
            LoadContentsWithSubCategory("Peinture", "Artisanat");
            /* FruitList.Add(new Nourriture { Owner = "Mazouni Anas", OwnerTel = "98.227.237", Name = "Pastéques", OwnerImg = "Assets/Anas.png", Lieu = "SidiBouzid,Tok", Quantite = "200", Prix = 1, Date = "02/02/2016", ImageNourriture = "Assets/Pasteque.jpg" });
             FruitList.Add(new Nourriture { Owner = "Sta Mohamed", OwnerTel = "21.225.987", Name = "Cerises", OwnerImg = "Assets/Sta.png", Lieu = "Nabeul,Kélibia", Quantite = "120", Prix = 2, Date = "19/11/2016", ImageNourriture = "Assets/Cerise.jpg" });
             FruitList.Add(new Nourriture { Owner = "Bouzwer Amar", OwnerTel = "98.922.123", Name = "Péches", OwnerImg = "Assets/Amar.png", Lieu = "Beja,Matteur", Quantite = "80", Prix = 5, Date = "15/12/2016", ImageNourriture = "Assets/Peche.jpg" });
             FruitList.Add(new Nourriture { Owner = "Benkhelifa Myriam", OwnerTel = "98.922.123", Name = "Pommes", OwnerImg = "Assets/UserHraderImg.png", Lieu = "Kef,Tajerouine", Quantite = "200", Prix = 5, Date = "15/12/2016", ImageNourriture = "Assets/Pomme.jpg" });
