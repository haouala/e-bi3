...
//  $result =mysqli_query($link, 'SELECT * FROM product where price in ("'.$_GET['min'].'","'.$_GET['max'].'")');
  $result =mysqli_query($link, 'SELECT * FROM product where price > "'.$_GET['min'].'" and price <"'.$_GET['max'].'"');
